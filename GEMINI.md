...
For autonomous evolution runs, the Agent workflow normally provides a compact context bundle generated by `scripts/build-agent-context.sh`. Treat that bundle as the first-pass operating context because it is derived from:
