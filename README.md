...
At cycle 4318, the garden contains 6283 organisms across fern,moss root network,spore. Available nutrients are 7, the nutrient buffer is 100, and missing roles are fungus,herbivores predators; the next useful changes should improve recoverable ecosystem behavior rather than add bookkeeping.
