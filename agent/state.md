...
- Added 'buffer-tapper' logic for animals, allowing them to tap the nutrient buffer when starving and the buffer is available, bridging animal survival to the root-network buffering system.
