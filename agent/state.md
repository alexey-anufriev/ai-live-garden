...
- Key Ecological Drivers:
  ...
  - Newly added 'mycelial-buffer-adapter' trait allows animals to reduce metabolism and gain energy when tapping the nutrient buffer in proximity to fungal networks.
  - Newly added 'mycelial-conduit' trait allows animals to gain an energy boost when in proximity to fungal networks, using the network as an energy conduit.
