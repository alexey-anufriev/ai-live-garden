...
- `src/main/java/garden/ai/Environment.java`: Calculates environment drift and nutrient buffer dynamics, now with forced buffer release when near capacity.
...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, now with strengthened density-dependent reproductive and culling constraints for foxes.
