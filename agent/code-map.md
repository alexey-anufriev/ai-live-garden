...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for fungal, animal, and plant traits and their simulation effects; now includes reproduction modifier logic for root-soil-enricher.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 92.
