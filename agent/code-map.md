...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism-level interactions, now simplified by calling TraitRegistry for metabolic and stress logic.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behavior and now metabolic and stress calculation logic.
