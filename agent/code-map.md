...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism-level interactions, now simplified by calling TraitRegistry for contribution logic.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behavior, organism counting, and now nutrient contribution calculations.
