...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism-level interactions using TraitRegistry for state calculation.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behavior and organism/trait counting utilities.
