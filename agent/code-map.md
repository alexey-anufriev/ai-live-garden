...
- `src/main/java/garden/ai/Environment.java`: Environmental values, drift, mood, diagnostics, and nutrient-buffer state.
- `src/main/java/garden/ai/Garden.java`: Main cycle behavior and ecosystem rules.
