...
- `src/main/java/garden/ai/Environment.java`: Calculates environment drift and nutrient buffer dynamics, now with conditional inflow diversion to nutrients.
...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, now with population-dependent metabolic penalties for foxes.
