...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for organism traits and metabolic logic, now including 'fox-metabolic-efficiency' in the fox mutation pool.
