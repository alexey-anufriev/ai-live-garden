...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism-level dynamics; modified to assign 'resourceful-breeder' trait to beetles when the population is low.
