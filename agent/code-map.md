...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, now with corrected culling order and stress-based reproduction constraints.
