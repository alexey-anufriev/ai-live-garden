...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait effects, updated to include growth benefit for 'root-soil-enricher'.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 78.
