...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism interactions, including metabolism, reproduction, and environmental contribution.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait definitions and effect calculations, updated to facilitate trait mutation.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 106.
