...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism-level interactions including metabolism, reproduction, and trait assignment.
