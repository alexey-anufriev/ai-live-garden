...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculator for organism-level interactions, now more focused.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behaviors and interaction rules.
