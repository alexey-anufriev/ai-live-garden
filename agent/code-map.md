...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, now with corrected density-dependent reproductive constraints for foxes.
