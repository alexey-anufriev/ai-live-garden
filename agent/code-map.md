...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism interactions; updated mutation pool to include metabolic efficiency for foxes.
