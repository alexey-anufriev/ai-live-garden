...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism-level interactions, now more focused by delegating bite calculation to TraitRegistry.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behavior, now including bite calculation rules.
