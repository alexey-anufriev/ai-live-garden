...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism-level interactions including metabolism, stress, feeding, and reproduction.
