...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism interactions and birth budgets; now includes robust fox population control mechanisms.
