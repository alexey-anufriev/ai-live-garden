...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Consolidated calculator for organism-level interactions: metabolism, stress, feeding, reproduction, and colonization.
