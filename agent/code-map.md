...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait metabolic effects and feeding calculations, including beetle predation logic.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 116.
