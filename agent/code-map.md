...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait metabolic effects and feeding calculations, now includes optimized fungal decomposition pressure logic.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 119.
