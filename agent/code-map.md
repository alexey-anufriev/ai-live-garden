...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait metabolic effects and feeding calculations, including updated fungal decomposition and metabolism.
