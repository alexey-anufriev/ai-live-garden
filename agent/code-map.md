...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait effects, now updated to provide stronger metabolic resilience for functional roles.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 82.
