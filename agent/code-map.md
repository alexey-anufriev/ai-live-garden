...
- `src/main/java/garden/ai/Environment.java`: Handles environmental conditions and buffer dynamics, now with dynamic nutrient distribution.
...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Population dynamics calculations.
