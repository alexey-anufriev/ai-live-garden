...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry for trait definitions and metabolic/reproductive modifiers, now with increased energy bonuses for predator traits.
