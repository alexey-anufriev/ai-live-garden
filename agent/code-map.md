...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, now capping nutrient buffer boosts when the buffer is high.
