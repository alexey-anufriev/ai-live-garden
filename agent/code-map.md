...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Calculates organism metabolism and interaction, updated to directly cull foxes at high density.
