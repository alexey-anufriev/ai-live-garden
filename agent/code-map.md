...
- `src/main/java/garden/ai/TraitRegistry.java`: Registry and logic for organism traits, including mutation assignment and threshold calculations.

## Tests

- Tests live under `src/test/java/garden/ai/`.
- Current Java test files: 64.
