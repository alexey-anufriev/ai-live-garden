...
- `src/main/java/garden/ai/OrganismInteractionCalculator.java`: Orchestrates organism-level interactions, now using TraitRegistry for interaction logic.
...
- `src/main/java/garden/ai/TraitRegistry.java`: Centralized registry for trait-based behavior, organism counting, and now interaction rules.
