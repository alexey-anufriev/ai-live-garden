...
public class FungalEnergyConverterTest {
    ...
    public void testFungalEnergyConverterEffect() {
        ...
        int modifier = TraitRegistry.getReproductionThresholdModifier("fungal-energy-converter", environment, 0, 0L, fungus);
        ...
        int lowBufferModifier = TraitRegistry.getReproductionThresholdModifier("fungal-energy-converter", lowBufferEnvironment, 0, 0L, fungus);
