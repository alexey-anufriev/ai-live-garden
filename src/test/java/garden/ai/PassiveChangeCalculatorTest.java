...
class PassiveChangeCalculatorTest {
    ...
    void plantStressedWithoutFavoringEnvironment() {
        ...
        assertThat(PassiveChangeCalculator.isPlantStressed(moss, env, List.of())).isTrue();
    }
    ...
    void plantNotStressedWithFavoringEnvironment() {
        ...
        assertThat(PassiveChangeCalculator.isPlantStressed(moss, env, List.of())).isFalse();
    }
    ...
    void plantStressedInScarcityLosesEnergy() {
        ...
        PassiveChangeCalculator.StressResult result = PassiveChangeCalculator.calculatePlantStressResult(moss, env, 1, List.of());
    ...
    void animalNotStarvingInLowNutrientsWithHighBuffer() {
        ...
        assertThat(PassiveChangeCalculator.isAnimalStarving(fox, env, List.of())).isFalse();
    }
    ...
    void animalStarvingInLowNutrientsAndLowBuffer() {
        ...
        assertThat(PassiveChangeCalculator.isAnimalStarving(fox, env, List.of())).isTrue();
    }
    ...
    void plantStressedDueToOvercrowding() {
        ...
        assertThat(PassiveChangeCalculator.isPlantStressed(moss, env, manyMoss)).isTrue();
    }
}
