...
class EnvironmentTest {
    ...
    void nextCalculatesNutrientsCorrectly() {
        ...
        Environment next = env.next(1, 100, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    void bufferReleasesFasterWhenHigh() {
        ...
        Environment nextHigh = env.next(1, 100, 0, 0, 0, 0, 0, 0, 0, 0);
        ...
        Environment nextLow = envLow.next(1, 100, 0, 0, 0, 0, 0, 0, 0, 0);
