...
class OrganismStateCalculatorTest {
    ...
    void plantStressedWithoutFavoringEnvironment() {
        ...
        assertThat(OrganismStateCalculator.isPlantStressed(moss, env, List.of())).isTrue();
    }
    ...
    void plantNotStressedWithFavoringEnvironment() {
        ...
        assertThat(OrganismStateCalculator.isPlantStressed(moss, env, List.of())).isFalse();
    }
    ...
    void plantStressedInScarcityLosesEnergy() {
        ...
        OrganismStateCalculator.StressResult result = OrganismStateCalculator.calculatePlantStressResult(moss, env, 1, List.of());
    ...
    void animalNotStarvingInLowNutrientsWithHighBuffer() {
        ...
        assertThat(OrganismStateCalculator.isAnimalStarving(fox, env, List.of())).isFalse();
    }
    ...
    void animalStarvingInLowNutrientsAndLowBuffer() {
        ...
        assertThat(OrganismStateCalculator.isAnimalStarving(fox, env, List.of())).isTrue();
    }
    ...
    void plantStressedDueToOvercrowding() {
        ...
        assertThat(OrganismStateCalculator.isPlantStressed(moss, env, manyMoss)).isTrue();
    }
}
