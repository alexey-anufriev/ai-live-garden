...
public class FungalRootSymbiontReproductionTest {
    ...
    public void testFungalRootSymbiontLowersReproductionThreshold() {
        ...
        int threshold1 = OrganismInteractionCalculator.reproductionThreshold(root, env, fungalContribution);
        int threshold2 = OrganismInteractionCalculator.reproductionThreshold(symRoot, env, fungalContribution);
