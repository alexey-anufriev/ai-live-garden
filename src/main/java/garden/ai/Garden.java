...
public record Garden(int cycle, int nextId, Environment environment, List<Organism> organisms, List<GardenEvent> events) {
    ...
    public Garden nextCycle() {
        ...
        Environment nextEnvironment = environment.next(nextCycle, (int) plantCount, (int) animalCount, rootContribution(releaserCount), fungalContribution(), (int) ((mossConserverCount + mossScavengerCount + fernConserverCount) / 5), (int) demandRegulatorCount / 2, (int) mobilizerCount, (int) releaserCount);
