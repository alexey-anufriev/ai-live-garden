...

{
  ...
  echo "- Generated \`agent/state.md\`: $(changed_exact "agent/state.md")"
  echo "- Generated README current-state block candidate: $(changed_exact "README.md")"
  echo "- Generated active journal: $(changed_under "agent/journal/")"
  echo "- Generated summaries: $(changed_under "agent/summaries/")"
