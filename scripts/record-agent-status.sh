...

{
  ...
  echo "- Run mode: ${AGENT_RUN_MODE:-}"
  echo "- Derived shadow policy: ${AGENT_SHADOW_POLICY:-}"
  echo "- Candidate validation outcome: ${CANDIDATE_VALIDATION_OUTCOME:-}"
  echo "- Shadow evaluation outcome: ${SHADOW_EVALUATION_OUTCOME:-}"
  echo "- Shadow safety evaluation outcome: ${SHADOW_SAFETY_EVALUATION_OUTCOME:-}"
