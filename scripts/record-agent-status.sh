...

{
  ...
  echo "- Shadow corrective retry outcome: ${SHADOW_RETRY_OUTCOME:-}"
  echo "- Shadow corrective test outcome: ${SHADOW_RETRY_POST_TEST_OUTCOME:-}"
  echo "- Shadow corrective evaluation outcome: ${SHADOW_RETRY_EVALUATION_OUTCOME:-}"
