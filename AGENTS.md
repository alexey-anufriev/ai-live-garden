...
- `agent/state.md`, `agent/code-map.md`, README state, `agent/journal/`, and `agent/summaries/` are generated by post-processing during autonomous runs.
...
- generated memory files: `README.md`, `agent/state.md`, `agent/requests.md`, `agent/code-map.md`, `agent/journal/`, `agent/summaries/`, or `agent/templates/`;
